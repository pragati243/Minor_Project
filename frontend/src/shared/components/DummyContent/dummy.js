...
const DummyContent = () => {
    return (<div  class="container1">
        <div style={{ margin: '0 auto', maxWidth: '800px', padding: '0 16px' ,}}>
        <p class="text2">ABOUT IIIT-NR
        Highlights
        ...
        Dr. SPM IIIT-NR's fifty-acres residential campus is located in the newly developed smart city of Atal Nagar,
         ...
         The classrooms are equipped with state-of-the art technologies for teaching and learning.</p>
        Highlights
