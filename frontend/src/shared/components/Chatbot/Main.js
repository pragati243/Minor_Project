...
const Main = () => {
  ...
  const Intent = async (g) => {
    ...
    <div class="d-flex flex-row justify-content-end mb-4 pt-1 text-end"> <!-- added text-end class -->
        <div>
            <p class="small p-2 me-3 mb-3 text-white rounded-3 bg-warning">
                ${message}
            </p>
        </div>
        <img src="https://w7.pngwing.com/pngs/1008/377/png-transparent-computer-icons-avatar-user-profile-avatar-heroes-black-hair-computer.png" alt="avatar 1" class="image"/>
    </div>`;
